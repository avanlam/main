...
% COMPUTE_QOIS : Computes the quality indices or synchronisation measures
% for the given state and time sequence, based on the estimation of the
% phase and period of the oscillators
% Author : Niccolo Discacciati (EPFL)
    ...
    if estimated_period < 20
        disp(estimated_period)
    end
