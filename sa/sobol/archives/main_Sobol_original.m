function [ Sobol_inp , Sobol_out ] = main_Sobol()
...
funPath = 'HBV-SASK'; % 3. Folder address: that includes model file, factor space
...
%% Store Results
save ('Results_Sobol', 'Sobol_inp', 'Sobol_out');
end
%% ************************************************************************
%  ***********                  Sub-functions                   ***********
%  ******                                                            ******
...
for i = 1 : numDim
    FO(i) = ( ( yA' * yC(:, i) ) / N - f0 ^ 2 ) / Vy;     % First-Order effect
