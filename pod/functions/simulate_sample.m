function [full_outp, ROM_outp, pROM_outp] = simulate_sample(sample, params, tau, time, U_pod, V_pod)
%SIMULATE_SAMPLE simulates the modified Goodwin sample at the parameter
...
%     tic;
%     [time_deim,x_deim_proj]=RK3(@(t,x) PTUinv*circadian_rhs_colloc(t,x,params,PTtau,PTU,meanU_v), [0 time.final_time], U_pod'*time.x0, dt);
